...
repo --name "extras" --baseurl="https://dl.rockylinux.org/stg/rocky/10/extras/$basearch/os/"
repo --name "crb" --baseurl="https://dl.rockylinux.org/stg/rocky/10/CRB/$basearch/os/"
