# Kickstart to build Rocky 10 image for Raspberry Pi 4 hardware (aarch64)
#
...
# Repos setup:
url --url http://download.rockylinux.org/stg/rocky/10/BaseOS/aarch64/os/
repo --name="BaseOS"     --baseurl=http://download.rockylinux.org/stg/rocky/10/BaseOS/aarch64/os/ --cost=100
